...
int main(){
	...
	// ---------------------
	std::cout << "rmse " << sqrt( (distances.dot(distances)) / (double)v_data.size()) << " m\n";
	std::cout << "mean " << distances.mean() << " m\n";
	//std::cout << "median " << distances.median() << " m\n";
	//std::cout << "std " << rmse << " m\n";
	std::cout << "min " << distances.minCoeff() << " m\n";
	std::cout << "max " << distances.maxCoeff() << " m\n";
 



	// Imprimir algunos valores
	//for(int i = 0; i < RBM_data.size(); ++i){
	//	std::cout << i << " " << vertices_data[i*3+0] << " " << vertices_data[i*3+1] << " " << vertices_data[i*3+2] << "\n";
	//}
